...
class ResourceController extends BaseResource
{
    ...
    public function getIndexCatalogo($model, $prefijoCampos, $camposQueryParams, $campos)
    {
        ...
        try {
            ...
            return $this->respondPlpx("server_error", lang("CommonErrors.solicitudNoProcesada"));
        }
    }
    ...
    public function getShowCatalogo($model, $prefijoCampos, $camposQueryParams, $campos, $id)
    {
        ...
        try {
            ...
            if (!$this->validateId($id)) {
                return $this->respondPlpx("invalid_request", lang("CommonErrors.idInvalido"));
            }
            ...
            //log_message("error", $e);
            $logger->log("critical", $e, __LINE__);
            return $this->apiResponseError("server_error", lang("CommonErrors.solicitudNoProcesada"));
        }
    }
